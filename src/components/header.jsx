        ...
        <>
            <div className="flex items-center justify-between w-full p-3 py-5 lg:px-20">
                ...
                <div className="items-center hidden gap-10 md:flex">
                    ...
                    <Link href={"https://hackwithindia.devfolio.co"} target="_blank" className="px-8 py-4 font-semibold bg-amber-500 rounded-tr-2xl rounded-bl-2xl">Coming Soon</Link>
                </div>
                <div className="flex md:hidden">
                    <Link href={"https://hackwithindia.devfolio.co"} target="_blank" className="p-4 text-sm font-semibold sm:py-4 sm:px-8 bg-amber-500 rounded-tr-2xl rounded-bl-2xl">Coming Soon</Link>
                </div>
            </div>
